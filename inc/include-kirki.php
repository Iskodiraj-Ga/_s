	...
	class Kirki_Installer_Section extends WP_Customize_Section {
		...
		protected function render() {
			...
			<div style="padding:10px 14px;">
				...
				<?php else : ?>
					<?php esc_attr_e( 'A plugin is required to take advantage of this theme\'s features in the customizer.', 'textdomain' ); ?>
					<a class="install-now button-secondary button" data-slug="kirki" href="<?php echo esc_url_raw( $plugin_activate_url ); ?>" aria-label="Activate Kirki Toolkit now" data-name="Kirki Toolkit"><?php esc_html_e( 'Activate Now', 'textdomain' ); ?></a>
				<?php endif; ?>
			</div>
			<?php
		}
